...
namespace Ajsuth.Sample.ImageExport.Engine.Pipelines.Blocks
{
    ...
    public class PrepareAzureStorageBlock : AsyncPipelineBlock<ExportImagesArgument, ExportImagesArgument, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<ExportImagesArgument> RunAsync(ExportImagesArgument arg, CommercePipelineExecutionContext context)
        {
            ...
            if (!arg.AzureStorageSettings.IsValid())
            {
                return await Task.FromResult(arg);
            }

            context.CommerceContext.AddObject(new AzureStorageService(arg.AzureStorageSettings));
