...
namespace Ajsuth.Sample.ImageExport.Engine.Service
{
    public class AzureStorageService
    {
        ...
        public AzureStorageService(AzureStoragePolicy cloudStoragePolicy)
        {
        ...
        public async Task<bool> FileExists(string reference)
        {
            await this.Init();
            return await Container.GetBlockBlobReference(reference).ExistsAsync();
        }
